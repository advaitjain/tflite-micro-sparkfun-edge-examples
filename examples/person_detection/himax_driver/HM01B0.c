...
uint32_t hm01b0_single_frame_capture(hm01b0_cfg_t* psCfg) {
  hm01b0_write_reg(psCfg, HM01B0_REG_PMU_PROGRAMMABLE_FRAMECNT, (uint8_t*) 0x01, 1);
  hm01b0_write_reg(psCfg, HM01B0_REG_MODE_SELECT,
                   (uint8_t*) HM01B0_REG_MODE_SELECT_STREAMING_NFRAMES, 1);
  hm01b0_write_reg(psCfg, HM01B0_REG_GRP_PARAM_HOLD, (uint8_t*)0x01, 1);
}
